...
export default function signup() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-gradient-to-b from-green-50 to-emerald-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-lg">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-gray-900">
            Get Started with EcoRate 
          </h2>
          <p className="mt-2 text-gray-600">
            Create a free account or <Link href="/Signin">log in</Link>to get started
          </p>
        </div>
